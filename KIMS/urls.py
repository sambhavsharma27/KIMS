...
urlpatterns = [
    ...
    path('room/<int:room_id>/item/<int:item_id>/update/', views.update_item_info, name='update_item_info'),
    path('room/<int:room_id>/add-new-item-modal/', views.add_new_item_from_modal_view,
         name='add_new_item_modal_submit'),
